...
if($_POST['accion'] == 'crear'){
     ...
     try {
          $stmt = $conn->prepare("INSERT INTO empleado (nombre, apellidos, domicilio, sueldo, fecha) VALUES (?, ?, ?, ?, ?)");
...
if($_POST['accion'] == 'editar') {
     ...
     try{
          $stmt = $conn->prepare("UPDATE empleado SET nombre = ?, apellidos = ?, domicilio = ?, sueldo = ?, fecha = ? WHERE id = ?");
